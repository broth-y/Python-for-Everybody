...
a = thing()                        # only typing thing() will execute it later, this is for defining it
a                         # we CALL the function here ----> prints 'Hello' and 'Fun' as dictated by its definintion code
print('Zip')
a                         # same thing here
...
minmax()                    # calls for the results of the code (finding min/max and then printing said variable)
